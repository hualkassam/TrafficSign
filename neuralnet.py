...
relu = lasagne.nonlinearities.rectify # http://lasagne.readthedocs.org/en/latest/modules/nonlinearities.html
...
def build_model(): # http://lasagne.readthedocs.org/en/latest/modules/layers.html
    ...
    conv = lasagne.layers.Conv2DLayer(inp,  num_filters=8, filter_size=(3, 3), nonlinearity=relu) # http://lasagne.readthedocs.org/en/latest/modules/layers/conv.html
    conv = lasagne.layers.MaxPool2DLayer(conv, pool_size=(2, 2)) # http://lasagne.readthedocs.org/en/latest/modules/layers/pool.html#lasagne.layers.MaxPool2DLayer
    ...
    hid1 = lasagne.layers.DenseLayer(conv, num_units=16, nonlinearity=relu) # http://lasagne.readthedocs.org/en/latest/modules/layers/dense.html#lasagne.layers.DenseLayer
    ...
    out = lasagne.layers.DenseLayer(hid2, num_units=14, nonlinearity=lasagne.nonlinearities.softmax) # http://lasagne.readthedocs.org/en/latest/modules/nonlinearities.html#lasagne.nonlinearities.softmax
